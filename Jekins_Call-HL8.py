...
def update_cfg():
    ...
    for field in ["HARD_INI","SOFT_INI","NETWORK_INI","SIM_INI","AUX_SIM_INI","AUX2_SIM_INI","AVMS_INI","AVMS_LOCAL_DELTA","AVMS_LOCAL_DELTA_FALLBACK","PowerSupply","CMW_USB_PORT"]:
        try:
            if field in os.environ:
